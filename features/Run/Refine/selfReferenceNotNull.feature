Feature:
  ...
  Scenario: We want to refine table that references itself - column is NotNull
    ...
    And the table users in target database should have 2 rows
